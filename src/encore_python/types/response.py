...
class TrackIssue(jsonobject.JsonObject):
    instrument = instrument = jsonobject.StringProperty(name="instrument", choices=instruments, exclude_if_none=False)
...
class NotesData(jsonobject.JsonObject):
    ...
    has_forced_notes = jsonobject.BooleanProperty(name='hasForcedNotes', exclude_if_none=True)
    has_tap_notes = jsonobject.BooleanProperty(name='hasTapNotes', exclude_if_none=True)
    has_open_notes = jsonobject.BooleanProperty(name='hasOpenNotes', exclude_if_none=True)
    has_2x_kick = jsonobject.BooleanProperty(name='has2xKick', exclude_if_none=True)
    has_roll_lanes = jsonobject.BooleanProperty(name='hasRollLanes', exclude_if_none=True)
...
class Song(jsonobject.JsonObject):
    ...
    diff_guitar_coop_ghl = jsonobject.IntegerProperty(name='diff_guitar_coop_ghl', default=-1)
